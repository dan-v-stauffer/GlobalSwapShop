...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <fvk:loginbutton id ="FacebookLoginbutton" Title="<%$ Resources:GlobalSwapShop, CONNECT_WITH_FACEBOOK %>" runat="server" OnConnectCalled="OnConnected" Permissions='"email"' />
    </asp:TableCell>
    </asp:TableRow>
    </asp:Table>
</asp:Content>